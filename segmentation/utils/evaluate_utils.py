...
def eval_segmentation_supervised_offline_distill(n_classes, save_dir, val_dataset, verbose=True):
    # TODO: Merge with eval_segmentation_supervised_offline
    """ Evaluate stored predictions from a segmentation network.
        ...
        The distilled predictions at save_dir are used here.
    """
    # Iterate
    tp = [0] * n_classes
    fp = [0] * n_classes
    ...
    for i, sample in enumerate(val_dataset):
        ...
        # Load result
        filename = os.path.join(save_dir, sample['meta']['image'] + '.png')
