#
# This code is from the Torchvision repository, which was licensed under the BSD 3-Clause.
...
class _VOCBase(VisionDataset):
    ...
    def __init__(
        ...
        # make sure the file exists: /path/to/VOCdevkit/VOC2012/ImageSets/Main/{split}.txt
        valid_image_sets = ["train", "trainval", "val", "val_seg", "train_all", "trainaug_seg", "instance"]
        if year == "2007":
